;;; jdee-widgets.el -- Custom-style widgets used by the JDE
;; $Id$
...
;; FIXME: refactor
;; jdee-dbs-java-udci-p, jdee-dbs-get-string, jdee-dbs-cmd-exec,
;; jdee-dbo-locals-open-p, jdee-dbs-java-array-p, jdee-dbs-java-primitive-p,
;; jdee-dbs-java-null-p, jdee-dbs-get-object, jdee-dbs-get-array
...
(define-widget 'jdee-widget-tree-open-button 'item
  "Open node in `jdee-tree' widget."
  :button-prefix "["
  :button-suffix "]"
  :tag "+"
  :action 'jdee-widget-tree-open-button-callback
  :help-echo "Show subtree."
  :format "%[%t%]")

(defun jdee-widget-tree-open-button-callback (widget &optional event)
  ;; Set parent state to open.
  (widget-value-set (widget-get widget :parent) t))

(define-widget 'jdee-widget-tree-close-button 'item
  "Close node in `tree' widget."
  :button-prefix "["
  :button-suffix "]"
  :tag "-"
  :action 'jdee-widget-tree-close-button-callback
...
(define-widget 'jdee-widget-tree 'default
  ...
  :value-create 'jdee-widget-tree-value-create-callback
...
(define-widget 'jdee-widget-dtree 'default
...
(widget-create 'jdee-widget-dtree :tag NAME :node-fcn NODE-FUNCTION)
...
tree."
  ...
  :prefix-extra "    "
  :value-get 'widget-value-value-get
  :value-create 'jdee-widget-dtree-create-callback
  :value-delete 'widget-children-value-delete
  :has-nodes t)
...
(defun jdee-test-get-fields (process object-id)
  (list
...
(defun jdee-widget-java-obj-get-fields (obj-widget)
...
the object exists, and  ID is the debugger id for the object."
  :dynargs 'jdee-widget-java-obj-get-fields
  :has-children t)


(defun jdee-widget-java-array-element-to-tree (process element index)
  (cond
...
expand button causes the widget to display the values of the array."
  :dynargs 'jdee-widget-java-array-get-elements
  :has-children t)
...
(defun test-obj ()
  ...
  (widget-create 'jdee-widget-java-obj :tag "jmath.System s"   :process "process" :object-id 1)
  (widget-create 'jdee-widget-java-obj :tag "java.awt.Frame frame1" :process "process" :object-id 1)
...
(defun jdee-widget-option-tree-open-button-callback (widget &optional event)
  ;; Set parent state to open.
  (widget-value-set (widget-get widget :parent) t)
  (widget-setup))

(define-widget 'jdee-widget-option-tree-open-button 'item
  "Button to open an option tree."
  :button-prefix "["
  :button-suffix "]"
  :tag "+"
  :action 'jdee-widget-option-tree-open-button-callback
  :help-echo "Show option tree."
  :format "%[%t%]")

(define-widget 'jdee-widget-option-tree-close-button 'item
  "Close node in `jdee-widget-option-tree' widget."
  :button-prefix "["
  :button-suffix "]"
  :tag "-"
  :action 'jdee-widget-option-tree-close-button-callback
...
(define-widget 'jdee-widget-option-tree 'default
  "A panel containing widgets."
  :convert-widget 'widget-types-convert-widget
  :format "%v"
  :value-get 'widget-value-value-get
  :value-create 'jdee-widget-option-tree-value-create-callback
  :value-delete 'widget-children-value-delete)
...
(provide 'jdee-widgets)

;; End of jdee-widgets.el
